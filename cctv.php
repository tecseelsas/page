...
<body>
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1>
          <!-- <a href="#intro" class="scrollto">Tecseel</a> -->
          <!-- Uncomment below if you prefer to use an image logo -->
          <a href="#intro"><img src="img/logo-tecseel.svg" alt="tecseel" /></a>
        </h1>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-has-children"><a href="">Productos</a>
            <ul>
              <li><a href="#">CCTV</a></li>
              <li><a href="#">CA (Control de acceso)</a></li>
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-web">Kit's</li>
            </ul>
          </div>
        </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            <div id="logo" class="pull-left">
              <h1>
                <!-- <a href="#intro" class="scrollto">Tecseel</a> -->
                <!-- Uncomment below if you prefer to use an image logo -->
                <img src="img/logo-tecseel.svg" alt="tecseel" style="width:100%;" />
              </h1>
            </div>
            <!-- <h3>BizPage</h3> -->
            <p style="font-family: 'Comfortaa'">
              Contamos con los recursos y la infraestructura, que desarrolla y presenta propuestas de valor
              innovadoras,
              con espíritu
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="ion-ios-arrow-right"></i> <a href="productos.html">Productos</a></li>
              <li><i class="ion-ios-arrow-right"></i> <a href="#portfolio">Trabajos</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              Calle 8 No. 25 55 <br>
              Fonseca, La Guajira<br>
              Colombia <br>
              <strong>Phone:</strong> +57 (302) 227 9723<br>
              <strong>Email:</strong> tecseelsas@gmail.com<br>
            </p>
          ...
          <div class="col-lg-3 col-md-6 footer-newsletter">
            ...
            <p>Suscríbete para tenerte informad@ con respectó a temas de tecnología y seguridad electrónica.</p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong style="font-family: 'Comfortaa'">Tecseel SAS</strong>. Todos los derechos reservados
      </div>
      <div class="credits">
        by | LT-Soft
      </div>
